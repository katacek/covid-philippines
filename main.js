...
Apify.main(async () =>
{
    ...
    await page.goto('https://dohph.maps.arcgis.com/apps/opsdashboard/index.html#/3dda5e52a7244f12a4fb3d697e32fd39'), { waitUntil: 'networkidle2', timeout: 60000 };
    ...
    if ( !result.infected || !result.tested || !result.deceased|| !result.recovered|| !result.deceased|| !result.PUIs|| !result.PUMs) {
                check = true;
            }
    else {
